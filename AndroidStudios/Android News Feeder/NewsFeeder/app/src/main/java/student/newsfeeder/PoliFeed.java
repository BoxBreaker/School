...
public class PoliFeed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poli_feed);

        lvPoli = (ListView) findViewById(R.id.lv_poli);

        titles = new ArrayList<String>();
        links = new ArrayList<String>();

        lvPoli.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(PoliFeed.this);
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(PoliFeed.this, android.R.layout.simple_list_item_1, titles);

            lvPoli.setAdapter(adapter);
