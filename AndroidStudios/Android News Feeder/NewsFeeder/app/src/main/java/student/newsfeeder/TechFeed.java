...
public class TechFeed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_feed);

        lvTech = (ListView) findViewById(R.id.lv_Tech);
    ...
    {
        ProgressDialog progressDialog = new ProgressDialog(TechFeed.this);
        ...
        protected Exception doInBackground(Integer... params) {
            ...
            try
            {
                URL url = new URL("http://feeds.reuters.com/reuters/technologyNews");
        ...
        protected void onPostExecute(Exception s) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(TechFeed.this, android.R.layout.simple_list_item_1, titles);
